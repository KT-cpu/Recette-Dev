...
<body>
    ...
    <main>
        ...
        <button class="Card1"><a href="PageRizauLait.php" class="fill-div"><img src="Images/<?php echo $img1 ?>" class="IMGButton1">
            <div class="Test">
            <div class="title"><?php echo $Titre1 ?></div>
            <div class="name"><?php echo $Myname ?></div>
            </div>
        </a></button>
        <button class="Card2"><a href="" class="fill-div"><img src="Images/<?php echo $img2 ?>" class="IMGButton2">
            <div class="Test2">
            <div class="title"><?php echo $Titre2 ?></div>
            <div class="name"><?php echo $Myname ?></div>
            </div>
        </a></button>
        <button class="Card3"><a href="" class="fill-div"><img src="Images/<?php echo $img3 ?>" class="IMGButton3">
            <div class="Test3">
            <div class="title"><?php echo $Titre2 ?></div>
            <div class="name"><?php echo $Myname ?></div>
            </div>
